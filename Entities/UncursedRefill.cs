...
namespace Celeste.Mod.LylyraHelper.Entities
{
    ...
    public class UncursedRefill : Refill
    {
        ...
        public UncursedRefill(EntityData data, Vector2 offset) : base(data.Position + offset, false, false)
        {
            ...
            sprite = Get<Sprite>();
            Remove(sprite);
            sprite.Reset(GFX.Game, "objects/lylyrahelper/uncurseddash/idle");
            sprite.AddLoop("idle", "", 0.1f);
            sprite.Play("idle");
            flash = Get<Sprite>();
            Remove(flash);
            flash.Reset(GFX.Game, "objects/lylyrahelper/uncurseddash/flash");
            Remove(Get<Image>());
            Add(sprite);
            Add(flash);
            ...
            Add(outline = new Image(GFX.Game["objects/lylyrahelper/uncurseddash/outline"]));
