...
namespace Celeste.Mod.LylyraHelper.Entities
{
    public class LylyraHelperModule : EverestModule
    {
        ...
        private Backdrop OnLoadBackdrop(MapData map, BinaryPacker.Element child, BinaryPacker.Element above)
        {
            ...
            {
                return new ASHWind(new Vector2(child.AttrFloat("x"), child.AttrFloat("y")), child.AttrInt("numWinds"), child.AttrFloat("initAngle"), child.AttrFloat("angleVariance"), child.AttrFloat("speed"), child.AttrFloat("speedVariance"), child.AttrFloat("twist"), child.AttrFloat("bend"), child.AttrFloat("frequency", 3F), child.AttrFloat("lifespan", 7.5F));
            }
            return null;
        }
