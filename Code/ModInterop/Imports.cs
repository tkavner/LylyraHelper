...
namespace Celeste.Mod.LylyraHelper.Code.ModInterop
{
    ...
    public class Imports
    {
        ...
        public static Action<Scene, Vector2, Solid, Solid, StaticMover> HandleStaticMover;
        public static Action<Scene, Vector2, Solid, Solid, List<StaticMover>> HandleStaticMovers;
